...
const RegisterShop = () => {
  ...
  const handlePinComplete = async (enteredPin) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || t('registerShopFailed'))
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-emerald-50 flex items-center justify-center px-4 py-8 overflow-hidden">
      {/* Language Toggle */}
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full border border-gray-100">
        ...
        {step === 'details' && (
          <>
            ...
            <form onSubmit={handleDetailsSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 text-white font-bold py-4 rounded-full hover:shadow-lg transition text-lg mt-6"
              >
                {t('nextSetPin')} →
              </button>
            </form>
        ...
        {step === 'success' && (
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 p-6 rounded-2xl mb-6 border border-emerald-100">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 text-white font-bold py-4 rounded-full hover:shadow-lg transition text-lg"
            >
              {t('goToDashboard')} →
            </button>
          </div>
